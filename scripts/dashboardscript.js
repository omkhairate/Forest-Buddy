$(document).ready(function () {
   ...
   var config = {
    ...
    function calcBill(score) {
        ...
        var energyBill = 70/score * 30;
        var waterBill = 70/score * 20;
    ...
    var rewards = localStorage.getItem("Rewards");
    $("#pointslabel").html("Tree Plantation No:- "+rewards);

    if(rewards > 2500) {
        $("#mathlabel").html("Congrats! You may claim a prize!");
    }
    else {
        $("#mathlabel").html((2500-rewards) +" more tress to complete target ");
    }
    ...
    function nextMove(){
        ...
        am4core.ready(function() {
            ...
            var avg = average(showerL)/28;

            $("#gauge2score").html(avg.toPrecision(3) + " Heat");
            setInterval(function() {
                hand.showValue(avg, 8000, am4core.ease.cubicOut);
            }, 8000);
        ...
        function drawBarChart() {
            ...
            var data = google.visualization.arrayToDataTable([
              ...
              ['Temperature', avgS, '#B3D9FF'],
              ['Heat', avgL/3, '#88BBE4'],
              ['Moisture', avgH * 6, '#87DCC0'],
            ]);
        ...
        function drawLineChart() {
          ...
          var options = {
            chart: {
              ...
              subtitle: 'Moisture, Temperature, and Heat' 
            },
            vAxes: {
                // Adds titles to each axis.
